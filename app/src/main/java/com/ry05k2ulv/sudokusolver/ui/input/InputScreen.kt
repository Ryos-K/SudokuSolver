...
fun InputScreen(
    ...
    Column {
        ...
        Keypad(modifier = Modifier
            ...
            onClick = { keyType ->
                when (keyType) {
                    is KeyType.Number -> ssViewModel.updateTable(keyType.n, selected)
                    is KeyType.Delete -> ssViewModel.updateTable(null, selected)
